...
class comsolFields():
    ...
    def nearfieldPoint0toPoint1(self,cut0,cut1):
        ...
        #w2 = self.k0**2 - kxcoordinatesMatrix**2 - kxcoordinatesMatrix**2
        #w=np.conjugate(np.sqrt(w2))
        print(self.zValueZeroedplane['Ex'][cut0])
        Ehatx = factorf*np.fft.fft2(self.zValueZeroedplane['Ex'][cut0]) #transformada de Fourier 2 D de self.zValueZeroedplane['Ex'][cut0]
        #print(Ehatx)
...
if __name__ == '__main__':
    ...
    fields.nearfieldPoint0toPoint1(1,1)                
    print("FIN PROGRAMA")
