...
def nearfieldPoint0toPoint1(fields,cut):
    ...
    for i in range(len(fields['zValueZeroedplane'].keys())):
        ...
        if fields_to_transform[i] in ['Ex','Ey','Ez']:
            ...
            #if fields_to_transform[i] =='normE':
    ...
    mapaDeRadiacion(phi_mesh,theta_mesh,suma)
        

def mapaDeRadiacion(theta_mesh,phi_mesh,Ehat_component_calculated):     
