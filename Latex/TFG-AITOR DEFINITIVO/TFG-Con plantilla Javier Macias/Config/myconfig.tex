...
\newcommand{\myBookTitleSpanish}{Diseño e Implementación en Software de un Algoritmo para la Conversión del Campo Cercano Esférico a Campo Lejano}
\newcommand{\myBookTitleEnglish}{Design and Software Implementation of an Algorithm for Spherical Near-Field to Far-Field Conversion}
\newcommand{\myThesisKeywords}{Cámara anecoica, CATECHOM, campo cercano, campo lejano, transformación de campo cercano a lejano}
\newcommand{\myThesisKeywordsEnglish}{Anechoic chamber, CATECHOM, near-field, far-field, near-field to far-field transformation}
\newcommand{\myConfidentialContent}{No} % This can be Yes or No, used
                                % in MUII as of July 2021

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Author data
\newcommand{\myAuthorName}{Aitor}
\newcommand{\myAuthorSurname}{Ingelmo Martin}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Advisor data
\newcommand{\myAcademicTutorFullName}{José Luis Álvarez Pérez} 
...
\newcommand{\myTribunalPresident}{María del Pilar Jarabo Amores}
\newcommand{\myTribunalFirstSpokesperson}{José María Muñoz Ferreras}
\newcommand{\myTribunalSecondSpokesperson}{José Luis Álvarez Pérez} 
...
\newcommand{\myThesisProposalDate}{18 de abril de 2023} % "Anteproyecto" date

\newcommand{\myThesisDepositDate}{1 de septiembre de 2024}
\newcommand{\myThesisDepositDateEnglish}{September 1\textsuperscript{st}, 2024}
